        ...
        stage('Deploy to AWS EC2') {
            steps {
                withCredentials([sshUserPrivateKey(credentialsId: 'ubuntu-aws', keyFileVariable: 'SSH_KEY_PATH')]) {
                    powershell '''
  					ssh -o StrictHostKeyChecking=no -i C:/Users/pmasu/downloads/jenkin.pem ubuntu@ec2-54-252-240-79.ap-southeast-2.compute.amazonaws.com "echo 'SSH Connection Successful'"
